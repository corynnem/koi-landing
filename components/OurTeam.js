    ...
    >
      ...
      >
        ...
        >
          <div 
          className="relative"
          style={headshotWrapper}>
            <img className="Yellow-border" src={headshot.src} style={headshotStyles} />
            <h3
            className="center-x yellow-square-footer"
            >Ben</h3>
          </div>
          <div
          className="relative"
           style={headshotWrapper}>
            <img className="orange-border" src={headshot.src} style={headshotStyles} />
            <h3
            className="center-x orange-square-footer"
            >Corynne</h3>
          </div>
          <div 
          className="relative"
